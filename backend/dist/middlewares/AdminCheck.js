...
exports.adminCheck = (0, responseHandler_1.responseHandler)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userData = req.user;
        if (!userData) {
            throw new errorHandler_1.default(400, false, "access denied, invalid admin");
        }
